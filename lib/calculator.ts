...
const LEGAL_BASIS: Record<GroundType, Record<Standard, string>> = {
  A: {
    denki: '電技解釈 第17条第1項 / 内線規程 資料1-3-6',
    naisen: '内線規程 1350-4表 / 資料1-3-6',
  },
  B: {
    denki: '電技解釈 第17条第2項・第24条 / 内線規程 資料1-3-6',
    naisen: '内線規程 1350-5表 / 資料1-3-6',
  },
  C: {
    denki: '電技解釈 第17条第3項 / 内線規程 資料1-3-6',
    naisen: '内線規程 1350-3表 / 資料1-3-6',
  },
  D: {
    denki: '電技解釈 第17条第4項 / 内線規程 資料1-3-6',
    naisen: '内線規程 1350-3表 / 資料1-3-6',
  },
}

// 計算式の根拠テキスト（全種共通）
export const FORMULA_BASIS =
  'S = 0.052 × I（mm²）\n銅線温度上昇式 θ=0.008t(I/A)² より導出\n条件: 故障電流=定格×20倍、遮断時間0.1s、温度上昇120℃'
